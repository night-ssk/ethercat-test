...
enum device_info
{
    ...
    motor2_alias = 0, motor2_position = 1, motor2_vid = 0x00000168, motor2_pid = 0x0000000a,
    motor3_alias = 0, motor3_position = 2, motor3_vid = 0x00000168, motor3_pid = 0x0000000a,
    motor4_alias = 0, motor4_position = 3, motor4_vid = 0x00000168, motor4_pid = 0x0000000a,
    motor5_alias = 0, motor5_position = 4, motor5_vid = 0x00000168, motor5_pid = 0x0000000a,
    motor6_alias = 0, motor6_position = 5, motor6_vid = 0x00000168, motor6_pid = 0x0000000a,
};
...
//直线电机2
    ...
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
        0x6081,0x00,&motor_parm[1].profile_velocity},
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
        0x6083,0x00,&motor_parm[1].profile_acc},
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
        0x6084,0x00,&motor_parm[1].profile_dec},
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
        0x6098,0x00,&motor_parm[1].home_way},
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
        0x6099,0x01,&motor_parm[1].home_spd_high},
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
        0x6099,0x02,&motor_parm[1].home_spd_low},
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
        0x609A,0x00,&motor_parm[1].home_acc},
    {motor2_alias, motor2_position, motor2_vid, motor2_pid,
...
//直线电机3
    ...
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
        0x6081,0x00,&motor_parm[2].profile_velocity},
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
        0x6083,0x00,&motor_parm[2].profile_acc},
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
        0x6084,0x00,&motor_parm[2].profile_dec},
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
        0x6098,0x00,&motor_parm[2].home_way},
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
        0x6099,0x01,&motor_parm[2].home_spd_high},
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
        0x6099,0x02,&motor_parm[2].home_spd_low},
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
        0x609A,0x00,&motor_parm[2].home_acc},
    {motor3_alias, motor3_position, motor3_vid, motor3_pid,
...
//直线电机4
    ...
    {motor4_alias, motor4_position, motor4_vid, motor4_pid, 
        0x6081,0x00,&motor_parm[3].profile_velocity},
    {motor4_alias, motor4_position, motor4_vid, motor4_pid,
        0x6083,0x00,&motor_parm[3].profile_acc},

    {motor4_alias, motor4_position, motor4_vid, motor4_pid,
        0x6084,0x00,&motor_parm[3].profile_dec},
    {motor4_alias, motor4_position, motor4_vid, motor4_pid,
        0x6098,0x00,&motor_parm[3].home_way},
    {motor4_alias, motor4_position, motor4_vid, motor4_pid,
        0x6099,0x01,&motor_parm[3].home_spd_high},
    {motor4_alias, motor4_position, motor4_vid, motor4_pid,
        0x6099,0x02,&motor_parm[3].home_spd_low},
    {motor4_alias, motor4_position, motor4_vid, motor4_pid,
        0x609A,0x00,&motor_parm[3].home_acc},
...
//直线电机5
    ...
    {motor5_alias, motor5_position, motor5_vid, motor5_pid,
        0x6081,0x00,&motor_parm[4].profile_velocity},
    {motor5_alias, motor5_position, motor5_vid, motor5_pid,
        0x6083,0x00,&motor_parm[4].profile_acc},
    {motor5_alias, motor5_position, motor5_vid, motor5_pid,
        0x6084,0x00,&motor_parm[4].profile_dec},
    {motor5_alias, motor5_position, motor5_vid, motor5_pid,
        0x6098,0x00,&motor_parm[4].home_way},
    {motor5_alias, motor5_position, motor5_vid, motor5_pid,
        0x6099,0x01,&motor_parm[4].home_spd_high},
    {motor5_alias, motor5_position, motor5_vid, motor5_pid, 
        0x6099,0x02,&motor_parm[4].home_spd_low},
    {motor5_alias, motor5_position, motor5_vid, motor5_pid,
        0x609A,0x00,&motor_parm[4].home_acc},
    {motor5_alias, motor5_position, motor5_vid, motor5_pid,
...
//直线电机6
    ...
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
        0x6081,0x00,&motor_parm[5].profile_velocity},
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
        0x6083,0x00,&motor_parm[5].profile_acc},
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
        0x6084,0x00,&motor_parm[5].profile_dec},
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
        0x6098,0x00,&motor_parm[5].home_way},
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
        0x6099,0x01,&motor_parm[5].home_spd_high},
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
        0x6099,0x02,&motor_parm[5].home_spd_low},
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
        0x609A,0x00,&motor_parm[5].home_acc},
    {motor6_alias, motor6_position, motor6_vid, motor6_pid,
